        ...
        <header class="site-navbar" role="banner">
            ...
            <div class="container">
                <div>
                    ...
                    <div id="titulo">
                        <h2><a class="text-white" style="text-shadow: 2px 2px 4px #000000;"><br>Publicações</a></h2>
                        <br>
                    </div>
                </div>
            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-sm-10 featured-work">
                                <h3>Publicações - Artes na UFRPE</h3>
                                <p>
                                    <?php include "html/noticias/publicacoes.html" ?>
                                </p>
                            </div>
                        </div>
