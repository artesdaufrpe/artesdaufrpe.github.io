...
<?php include "html/header.html" ?>
    ...
    <header class="site-navbar" role="banner">
      ...
      <div class="container">
        <div>
          ...
          <div id="titulo">
            <h2><a href="index.html" class="text-white"><br>Brigada Portinari (Paineis 01 e 02)</a></h2>
            <br>
          </div>
        </div>
      </div>
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item-manual home-slider owl-carousel overlap"> <!-- Carousel begin-->
      ...
      <div class="site-blocks-cover" style="background-image: url(images/obra5/1_DSC3714.NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.6">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra5/1_DSC3714.NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
      ...
      <div class="site-blocks-cover" style="background-image: url(images/obra5/2_DSC3713.NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.6">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra5/2_DSC3713.NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
                  style="margin-right:0%; margin-top:70%; color:rgb(255, 255, 255); opacity: 0.5;">
      ...
      <div class="site-blocks-cover" style="background-image: url(images/obra5/3_DSC3716.NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.6">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra5/3_DSC3716.NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
                  style="margin-right:0%; margin-top:70%; color:rgb(255, 255, 255); opacity: 0.5;">
