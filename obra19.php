                ...
                <div>
                    ...
                    <div id="titulo">
                        <h2><a class="text-white" style="text-shadow: 2px 2px 4px #000000;"><br>Placa dos Concluintes do
                                curso de Licenciatura em Ciências Domésticas do segundo semestre 1982</a></h2>
                        <br>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-11 col-sm-10 featured-work">
                            ...
                            <p>
                                ...
                                segundo semestre 1982 <br>
                                <b>Data:</b> julho de 1982 <br>
                                <b>Autor:</b> Corbiniano Lins <br>
                                <b>Dimensões:</b> 48cm x 38cm <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-11 col-sm-10 featured-work">
                            <h3>Sobre a Obra</h3>
                            <p>
                                Placa de formatura dos estudantes concluintes do curso de Licenciatura em Ciências Domésticas de 1982.2.
                            </p>
                        </div>
                    </div>
