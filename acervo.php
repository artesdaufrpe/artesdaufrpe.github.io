        ...
        <header class="site-navbar" role="banner">
            ...
            <div class="container">
                <div>
                    ...
                    <div id="titulo">
                        <h2><a class="text-white" style="text-shadow: 2px 2px 4px #000000;"><br>Todas as Obras</a></h2>
                        <br>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-stretch">
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                        <div class="unit-4 d-flex">
                            <div class="unit-4-icon mr-4"><span class="text-primary"><img style="width:100px"
                                        src="images/LOGO_color.png"></span></div>
                            <div>
                                <h3>Informe 1</h3>
