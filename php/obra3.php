...
<?php include "html/header.html" ?>
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item-manual home-slider owl-carousel overlap"> <!-- Carousel begin-->
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/obra3/obra3_p.jpg);" data-aos="fade" data-stellar-background-ratio="0.9">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra3/obra3.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/obra3/2_DSC3694_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.9">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
