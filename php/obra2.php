...
<?php include "html/header.html" ?>
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item-manual home-slider owl-carousel overlap"> <!-- Carousel begin-->
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/obra2/1_DSC3681_NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.9">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra2/1_DSC3681_NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/obra2/2_DSC3681_NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.9">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra2/2_DSC3681_NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
                  style="margin-right:0%; margin-top:70%; color:rgb(255, 255, 255); opacity: 0.5;">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/obra2/3_DSC3681_NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.9">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra2/3_DSC3681_NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
                  style="margin-right:0%; margin-top:70%; color:rgb(255, 255, 255); opacity: 0.5;">
                  Visualizar imagem ><br/>3 de 4
              </a></p>
            </div>
          </div>
        </div>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/obra2/4_DSC3678.NEF_P.jpg);" data-aos="fade" data-stellar-background-ratio="0.8">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="800">
              <p><a href="images/obra2/4_DSC3678.NEF.jpg" target="_blank" class="btn py-3 px-3 mb-5" 
                  style="margin-right:0%; margin-top:70%; color:rgb(255, 255, 255); opacity: 0.5;">
                  Visualizar imagem ><br/>4 de 4
              </a></p>
            </div>
          </div>
        </div>
    ...
    <div class="site-section block-13 bg-light overlap">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-7" data-aos="fade-up" data-aos-delay="400">
            ...
            <h2 class="text-white font-weight-light mb-5 h1">Visualizar o vídeo sobre a obra</h2>
